  ...
  return (
    <>
      <button
        ...
        title="Back to top"
        className={`fixed bottom-20 right-6 z-[9999] flex h-11 w-11 items-center justify-center rounded-full border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-500 dark:text-zinc-300 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl hover:bg-zinc-50 dark:hover:bg-zinc-700 active:scale-95 cursor-pointer ${showScrollTop ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}
      >
        <FaArrowUp size={14} />
      </button>
